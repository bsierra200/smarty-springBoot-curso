...
public class VacanteServiceImpl implements iVacanteService {
	...
	private List<Vacante> lista = null; //declarando lista como atributo a nivel de clase
	
	public VacanteServiceImpl() { //constructor que se ejecuta cada vez que se realiza una instancia
